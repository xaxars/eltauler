...
Escriu en català. Evita un tracte personalista (no parlis en segona persona). No facis servir numeracions de moviments, coordenades ni posicions exactes. No diguis el nom de les peces.
...
- Per CADA error greu, escriu EXACTAMENT aquest format:
  "[jugada feta] perd perquè [raó tàctica concreta]. Calia [jugada correcta] que [benefici concret]."
- Si no hi ha errors greus, explica que la lliçó és global amb una sola frase.
