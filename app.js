...
function updateOpeningPrecisionDisplay() {
    ...
    precisionEl.text(`${openingPracticeGoodMoves}/${openingPracticeTotalMoves} · ${precision}%`);
...
function processOpeningMoveAnalysis(bestMove) {
    ...
    try {
        ...
        openingPracticeAwaitingOk = openingPracticePendingEngineMove && openingPracticePrecisionReady;
...
function commitOpeningMoveFromTap(from, to) {
    ...
    // Primer decidir el moviment de l'engine (si toca)
    ...
    if (needsEngineMove && !wasWhiteTurn) {
